...
export type { BuildOptions, BuildResult, OpenOptions, OpenResult, Stages } from './store/index.ts';
export { buildIndex as build, CAPABILITY_NAMES, clearCache, openStore as open } from './store/index.ts';
