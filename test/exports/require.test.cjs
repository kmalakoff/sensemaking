...
const { build, CONFIG_FILENAME, clearCache, initConfig, loadConfig, mapTree, migrateConfig, open, peek, presetCoverage, printRows, runWatch, search, SenseError, SIGNAL_NAMES, STATE_DIR, SUPPORTED_CONFIG_VERSION } = require('sensemaking');
...
describe('exports .cjs', () => {
  it('named exports resolve through the require condition', () => {
    for (const fn of [mapTree, peek, presetCoverage, search, initConfig, loadConfig, migrateConfig, printRows, open, build, clearCache, runWatch]) assert.equal(typeof fn, 'function');
