...
// v4 entries name their verb, one to one with the two commands; a bare string is rejected with
// the corrected { sql } entry it should have been, not just a description of the problem.
