...
// band, 'total' (bulk_change_ms, bulk_watch_ms) is reported but never gates. One constant so
// compare.mjs, verdict.mjs and the harness test filter run.mjs's own fields the same way.
