---
date: 2026-08-13
title: obsidian-hub release-gate (0.6.0) — four-pass eval methodology introduced
...
corpora:
  ...
  - nfcorpus
  - fever
nfcorpus_ndcg10_semantic: 0.3444
nfcorpus_hit10_semantic: 0.7152
fever_ndcg10_semantic: 0.9435
fever_hit10_semantic: 0.9974
hub_cold_crawl_local_ms: 940
superseded_by: 2026-08-14-0.7.0-release-gate.md
---
...
Note: this sitting is the source of what the current BENCHMARKING.md calls "the 0.6.0
measurement" in its retrospective notes on the nfcorpus/fever tables (semantic-vs-fused
110W/77L z=2.4; fever bm25/fused 0.9436/0.9361 nDCG, 0.9969/0.9971 hit@10). Note the fever
semantic column here (0.9435 nDCG) reads as later releases' "the semantic column drifted
down... somewhere in 0.7.x-0.11.x" starting point.
